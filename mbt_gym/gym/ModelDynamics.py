...
class LimitOrderModelDynamics(ModelDynamics):
    ...
    def get_arrivals_and_fills(self, action: np.ndarray):
        # self.debug_file.write(f"action: {action}\n")
        ...
        # self.debug_file.write(f"arrivals: {arrivals}\n")
        # self.debug_file.write(f"depths: {depths}\n")
        # self.debug_file.write(f"fills: {fills}\n")

        # Explaination of the logic:
        # Action: is the spread on the bid and ask side chosen by the agent, which is applied on top of the midprice.
        # Arrival: Boolean array, where True means a MO has arrived and False means no MO has arrived.
        # Depth: same as the action, depth of the limit orders on the bid and ask side.
        # Fill: Boolean array, where True means a MO has been filled and False means no MO has been filled.
